        ...
        <Wrapper>
          ...
          <div className="text-center max-w-[800px] mx-auto my-[50px] md:my-[80px]">
            ...
            <div className="text-md md:text-xl">
              Explore a wide range of properties to rent or buy. Whether you're looking for a cozy apartment, a spacious family home, or an investment property, we have something for everyone. Start your search today and make your dream home a reality!
            </div>
          </div>
          {/* Heading end  */}
          {/* card start */}
          ...
          <div className="grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
            {productData.map((product) => (
              <Link
                ...
                className="relative"
              >
                <div className="block hover:scale-105 duration-1000 hover:shadow-indigo-400 rounded-lg p-4 mb-5 shadow-lg shadow-indigo-100">
